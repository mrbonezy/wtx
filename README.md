...
`wtx` drops each agent into its own ready branch worktree so teams can run truly parallel agent workflows.
Reuse + locking keep those parallel worktrees fast, isolated, and safe in large monorepos.
